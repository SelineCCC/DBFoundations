...
Create View vInventoriesByProductsByCategoriesByEmployees
 ...
 As
 Select Top 1000000000
  c.[CategoryID], [CategoryName], p.[ProductID], [ProductName], [UnitPrice], i.[InventoryID], [InventoryDate], [Count], i.[EmployeeID], 
  emp.EmployeeFirstName + ' ' + emp.EmployeeLastName AS Employee, mgr.EmployeeFirstName + ' ' + mgr.EmployeeLastName AS Manager
  FROM [dbo].Employees as emp
   Inner Join [dbo].Employees as mgr
    On mgr.EmployeeID = emp.ManagerID
   Inner Join [dbo].Inventories as i
